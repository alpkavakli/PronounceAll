...
7. **NFR-PERF-07 — page weight budgets: 150 KB word page / 200 KB for both `/learnIPA` and `/:variant/learnIPA`.** Excludes audio and fonts (which are cacheable and often preloaded). Intended to force discipline rather than match an industry average.
