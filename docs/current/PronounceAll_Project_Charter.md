...
- - Per-language `/:variant/learnIPA` page covering the variant's canonical pedagogical pronunciation inventory, defined normatively in the SDD and frequency-ordered, with the same save/tag system as words.
